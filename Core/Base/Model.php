...
class Model
{
    ...
    public function create($data) {     
        ...
        // var_dump($data_types);
        // die;
            // var_dump("INSERT INTO items (item_name, item_cost, buying_price, qty) VALUES (?,?,?,?)");
            // $stmt = $this->connection->prepare("INSERT INTO items (item_name, item_cost, buying_price, qty) VALUES ( ?, ?, ?, ?)");
            // $stmt->bind_param(siii,'test sql in.', '10', '10', '10' );
            // $stmt->execute();
            // $stmt->close();
            // var_dump("INSERT INTO items (item_name, item_cost, buying_price, qty) VALUES ('test sql in.', '10', '10', '10')");
            // die;
